...
arg = sys.argv[1]
rate, aud_data = wav.read('/home/chrysanthemum/Downloads/CaYPT Siren Recordings/'+arg+".wav")
rate_noise,noise_data = wav.read('/home/chrysanthemum/Downloads/CaYPT Siren Recordings/MotorSoundTest.wav')
