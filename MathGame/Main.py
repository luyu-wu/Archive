...
operators_available = [
    ...
    "MUL",
    "DIV",
]  # Operators available to the program.
...
data = {
    "settings": {
        ...
        "operators_allowed": [
            ...
            True,
            False,
        ],  # true false according to the operators_available table above
...
def GenerateQuestion():
    ...
    for i in range(
        settings["num_operands"] - 1
    ):  # -1 because it adds a operand after loop
        # Generate Operator
